CREATE OR REPLACE PROCEDURE STAGING.DYNAMICMAPPINGVALUE (
    ...
    o_cursor_product        OUT SYS_REFCURSOR,
    o_cursor_mcc            OUT SYS_REFCURSOR
)
AS
...
BEGIN
    ...
    IF v_count = 0 THEN
        OPEN o_cursor_product FOR SELECT NULL AS FIELD_VALUE_MAPPING, NULL AS FIELD_MAP_1 FROM DUAL WHERE 1 = 0;
        OPEN o_cursor_mcc FOR SELECT NULL AS FIELD_VALUE_MAPPING, NULL AS FIELD_MAP_1 FROM DUAL WHERE 1 = 0;
        RETURN;
    END IF;
